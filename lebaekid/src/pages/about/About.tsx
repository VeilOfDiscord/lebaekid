        ...
        <div className="grid justify-center md:px-15 px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="text-xl text-justify md:m-4">
              <ul className="p-5 bg-gray-300 rounded-xl">
                <li>
                  Lebaek.id adalah penyelenggara resmi event sepeda ultra
                  cycling endurance dengan nama "Berani Nanjak"
                </li>

                <li className="py-3 ">
                  Lebaek.id didirikan oleh Ale (Andre Leman) yang juga merupakan
                  pesepeda. Dan berdasarkan pengalaman Ale mengikuti beberapa
                  event sepeda dan ultra cycling di dalam maupun luar negeri
                  maka berdirilah Lebaik.id
                </li>
                <li className="py-3 ">
                  Dengan semangat komunitas dan kekeluargaan, Lebaek.id hadir
                  untuk memperkenalkan serta memberi kesempatan kepada para
                  pecinta sepeda agar dapat menikmati pengalaman Touring
                  Endurance dan Ultra Cyling untuk menjelajah rute-rute menarik
                  dan menantang di Indonesia maupun luar negri.
                </li>
                <li className="py-3 ">
